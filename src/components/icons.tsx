...
export const IconClipboard = ({ className }: P) => (
  <Outline vb="0 0 12 12" sw={1.5} className={className}>
    <path d="m7.75,1.75h.5c1.105,0,2,.895,2,2v5.5c0,1.105-.895,2-2,2H3.75c-1.105,0-2-.895-2-2V3.75c0-1.105.895-2,2-2h.5" />
    <rect x="4.25" y=".75" width="3.5" height="2.5" rx=".5" ry=".5" />
  </Outline>
)
...
export const IconAward = ({ className }: P) => (
  <svg viewBox="0 0 12 12" className={className} fill="none" aria-hidden="true">
    <path
      ...
      fill="currentColor"
    />
    <circle cx="6" cy="4.25" r="3.5" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
  </svg>
)
